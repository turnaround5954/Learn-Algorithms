...
public class Point implements Comparable<Point> {
  ...
  public static void main(String[] args) {
    ...
    StdOut.println(p1.toString() + " slope to (0, 0): " + p1.slopeTo(p0));
    StdOut.println(p2.toString() + " slope to (0, 0): " + p2.slopeTo(p0));
    ...
    StdOut.println("p1.slopeTo(p0) == p2.slopeTo(p0) ?: "
                   + Double.compare(p1.slopeTo(p0), p2.slopeTo(p0)));
    ...
    pArray[4] = p4;
    Arrays.sort(pArray);
    StdOut.print("Sorted by points: ");
    for (Point p : pArray) {
      StdOut.print(p.toString() + " ");
    }
    Arrays.sort(pArray, p0.slopeOrder());
    StdOut.print("\nSorted by slopes: ");
    for (Point p : pArray) {
      StdOut.print(p.toString() + " ");
    }
    // StdOut.print(p1.compareTo(p2));
  }
}
